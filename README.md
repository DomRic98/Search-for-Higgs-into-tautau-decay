...
Thanks to the CMS collaboration is possible to work on Simulated and Real data for the process <img src="https://latex.codecogs.com/gif.latex? H\to\tau_{\mu}\tau_{h} t " /> ([CMS Open Data](http://opendata.web.cern.ch/record/12350)).
