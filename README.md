...
Thanks to the CMS collaboration is possible to work on Simulated and Real data for the process <img src="https://render.githubusercontent.com/render/math?math=e^{i \pi} = -1"> ([CMS Open Data](http://opendata.web.cern.ch/record/12350)).
